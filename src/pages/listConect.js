...
export default class listConect extends Component {
  ...
  renderDashbordHeader = () => {
    return <DashbordHeader showback={false} headerText="EXPLORE DASHBOARD" />;
  };
    ...
    const data = [
      {
        ...
        finishTime: '2:14 PM',
        scriptText:
          "Hi this is <first name>. I'll be sharing my experience with <org>, so ask me any questions related to the same :)",
      },
      {
        id: 2,
        title: 'No Answer',
        finishTime: '2:15 PM',
        scriptText:
          'We are here to discuss my experience at <org>, you can find the answers to these online	',
      },
      {
        id: 3,
        title: 'No Answer',
        finishTime: '2:09 PM',
        scriptText:
          "Let's stick to the topic and get answers to questions which were related to the <org>. You can get these answers on a direct consulting call with me, so go ahead and press the consult button on my profile	",
      },
      {
        id: 4,
        title: 'Last Advice',
        finishTime: '2:09 PM',
        scriptText:
          "So keep calm <give a relavent trick for this particular company - eg: keep coding!>. If you follow this I'm sure you'll have a higher chances of getting into <org>!",
      },
      {
        id: 5,
        title: 'Silence',
        finishTime: '2:09 PM',
        scriptText:
          'A 15 sec video of you being ideal - not speaking - and listening to the questions being asked to you',
      },
      {
        id: 6,
      ...
      },
      {
        id: 8,
        title:
          'Before your interview what were the other rounds of shortlist? Mention tips related to that',
        scriptText: '',
        finishTime: '2:14 PM',
      },
      {
        ...
        <ScrollView style={{marginBottom: 20}}>
          ...
          <View
            ...
            <Text
              ...
              8 More Videos are pending before submitting
            </Text>
          </View>
